...
class EditClubPageWidget extends StatefulWidget {
  const EditClubPageWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ClubsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ClubsRecord> editClubPageClubsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final editClubPageClubsRecord = editClubPageClubsRecordList.isNotEmpty
            ? editClubPageClubsRecordList.first
            : null;
        return WillPopScope(
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.yourNameController ??=
                        ...
                        text: editClubPageClubsRecord?.clubName,
                      ),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.ageController ??=
                          TextEditingController(
                        text: editClubPageClubsRecord?.bio,
                      ),
                    ...
                    child: Padding(
                      ...
                      child: StreamBuilder<List<ClubsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<ClubsRecord> buttonClubsRecordList =
                              snapshot.data!;
