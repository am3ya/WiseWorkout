...
import 'manage_tips_model.dart';
export 'manage_tips_model.dart';

class ManageTipsWidget extends StatefulWidget {
  const ManageTipsWidget({super.key});

  @override
  State<ManageTipsWidget> createState() => _ManageTipsWidgetState();
}

class _ManageTipsWidgetState extends State<ManageTipsWidget> {
  late ManageTipsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManageTipsModel());
  }
