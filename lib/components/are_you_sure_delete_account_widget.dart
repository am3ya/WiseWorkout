...
import 'are_you_sure_delete_account_model.dart';
...
class _AreYouSureDeleteAccountWidgetState
    extends State<AreYouSureDeleteAccountWidget> {
  late AreYouSureDeleteAccountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AreYouSureDeleteAccountModel());
  }
