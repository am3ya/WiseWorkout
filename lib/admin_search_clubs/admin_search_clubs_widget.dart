...
import 'admin_search_clubs_model.dart';
export 'admin_search_clubs_model.dart';

class AdminSearchClubsWidget extends StatefulWidget {
  const AdminSearchClubsWidget({super.key});

  @override
  State<AdminSearchClubsWidget> createState() => _AdminSearchClubsWidgetState();
}

class _AdminSearchClubsWidgetState extends State<AdminSearchClubsWidget>
    with TickerProviderStateMixin {
  late AdminSearchClubsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminSearchClubsModel());
                    ...
                    child: StreamBuilder<List<ClubsRecord>>(
                      stream: queryClubsRecord(
                        queryBuilder: (clubsRecord) => clubsRecord.where(
                          'club_name',
                          isEqualTo: _model.searchUsersTextFieldController.text,
                        ),
                      ),
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          ...
                                          context.pushNamed('clubMembersPage');
                                        },
                                        child: Icon(
                                          Icons.arrow_right,
                                          color: FlutterFlowTheme.of(context)
