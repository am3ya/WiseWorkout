...
import 'business_account_view_exercise_model.dart';
...
class _BusinessAccountViewExerciseWidgetState
    extends State<BusinessAccountViewExerciseWidget> {
  late BusinessAccountViewExerciseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BusinessAccountViewExerciseModel());
