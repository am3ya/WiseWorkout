...
class _TestCalendarWidgetState extends State<TestCalendarWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<List<AdviceRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<AdviceRecord> testCalendarAdviceRecordList = snapshot.data!;
                                      ...
                                      children: [
                                        ...
                                        StreamBuilder<
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<GlobalPropertiesRecord>
                                                columnGlobalPropertiesRecordList =
                                                snapshot.data!;
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          () {
                                                                            if (valueOrDefault(currentUserDocument?.calorieDifference, 0.0) >
                                                                                0.0) {
                                                                              return 'Session';
                                                                            } else if (valueOrDefault(currentUserDocument?.calorieDifference, 0.0) ==
                                                                                null) {
                                                                              return 'Welcome!';
                                                                            } else {
                                                                              return 'Rest day';
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Padding(
                                                                              ...
                                                                              child: Text(
                                                                                dateTimeFormat('d/M/y', _model.calendarSelectedDay2!.start),
                                                                  ...
                                                                  InkWell(
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      if (valueOrDefault<bool>(
                                                                        ...
                                                                        if (valueOrDefault(currentUserDocument?.calorieDifference,
                                                                                0.0) >
                                                                            0.0) {
                                                                          context
                                                                              .pushNamed('startWorkoutTimer');
                                                                        } else {
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: () async {
                                                            setState(() {
                                                              FFAppState()
                                                                      .adviceRef =
                                                                  functions.randomAdvice(
                                                                      testCalendarAdviceRecordList
                                                                          .toList());
                                                            });
                                                          },
                                                          text: 'Refresh',
                                                                      ...
                                                                      children: [
                                                                        RichText(
                                                                          ...
                                                                          text:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              TextSpan(
                                                                                text: listViewAdviceRecord.creatorName,
                                                                                style: TextStyle(
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              FFAppState().brandName = listViewAdviceRecord.creatorName;
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        () {
                                                                          if (valueOrDefault(currentUserDocument?.calorieDifference, 0.0) >
                                                                              0.0) {
                                                                            return 'Session';
                                                                          } else if (valueOrDefault<bool>(currentUserDocument?.infoCollectionComplete, false) ==
                                                                              false) {
                                                                            return 'Welcome!';
                                                                          } else {
                                                                            return 'Rest day';
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            if (listViewAdviceRecord.creatorName !=
                                                                                'admin') {
                                                                              FFAppState().brandName = listViewAdviceRecord.creatorName;
                                                                              FFAppState().brandRef = listViewAdviceRecord.creatorRef;
