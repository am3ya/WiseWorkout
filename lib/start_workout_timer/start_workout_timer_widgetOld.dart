                                    ...
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.distanceTextFieldController,
                                        focusNode:
                                            _model.distanceTextFieldFocusNode,
                                        autofocus: true,
                                        readOnly: true,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.caloriesTextFieldController,
                                        focusNode:
                                            _model.caloriesTextFieldFocusNode,
                                        autofocus: true,
                                        readOnly: true,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                    ...
                                    child: Padding(
                                      ...
                                      child: AuthUserStreamWidget(
                                        builder: (context) => TextFormField(
                                          controller:
                                              _model.targetTextFieldController,
                                          focusNode:
                                              _model.targetTextFieldFocusNode,
                                          autofocus: true,
                                          readOnly: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
...
Padding(
  ...
  child: StreamBuilder<List<WorkoutsRecord>>(
    ...
    builder: (context, snapshot) {
      ...
      List<WorkoutsRecord> buttonWorkoutsRecordList = snapshot.data!;
      return InkWell(
        splashColor: Colors.transparent,
        focusColor: Colors.transparent,
        hoverColor: Colors.transparent,
        ...
        onLongPress: () async {
          ...
          await currentUserReference!.update({
            ...mapToFirestore(
              {
                'calorieDifference': FieldValue.increment(
                    -(double.parse(_model.caloriesTextFieldController.text))),
              },
            ),
          });
          FFAppState().timerState =
              FFAppState().timerState + _model.timerMilliseconds.toDouble();
          FFAppState().stepCount = FFAppState().stepCount +
              int.parse(_model.stepsTextFieldController.text);
          FFAppState().distance = FFAppState().distance +
              double.parse(_model.distanceTextFieldController.text);
          FFAppState().caloriesBurned = FFAppState().caloriesBurned +
              double.parse(_model.caloriesTextFieldController.text);
          if (buttonWorkoutsRecordList.first.hasDateUploaded()) {
            await buttonWorkoutsRecordList.first.reference.update({
              ...createWorkoutsRecordData(
                duration: FFAppState().timerState,
                stepsTaken: FFAppState().stepCount,
                caloriesBurned: FFAppState().caloriesBurned,
            ...
            await WorkoutsRecord.createDoc(currentUserReference!).set({
              ...createWorkoutsRecordData(
                duration: FFAppState().timerState,
                stepsTaken: FFAppState().stepCount,
                caloriesBurned: FFAppState().caloriesBurned,
        ...
        child: FFButtonWidget(
          onPressed: () async {
            ...
            await currentUserReference!.update({
              ...mapToFirestore(
                {
                  'calorieDifference': FieldValue.increment(-(double.parse(
                      _model.caloriesTextFieldController.text))),
                },
              ),
            });
            if (functions.durationDiff(
                    FFAppState().weekStart!, FFAppState().todaysDate!)! <
                6) {
